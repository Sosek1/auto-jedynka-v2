import banner from "../UI/images/banner.jpg";

export const Banner = () => {
  return (
    <div className="h-[calc(100vh-80px)] md:h-[70vh] relative bg-[url('https://firebasestorage.googleapis.com/v0/b/autojedynka-73a74.appspot.com/o/banner.jpg?alt=media&token=d718417f-574e-43a3-aa24-73c9a42d76ce')] bg-no-repeat bg-cover bg-center">
