  ...
  return (
    <>
      ...
      <section className="h-[20vh] md:m-x-[20px] hidden md:flex items-center justify-around">
        {icons.map(([icon, style]) => (
          <div
            ...
            className={`w-[80px] lg:w-[100px] h-[80px] lg:h-[100px] flex items-center justify-center ${style} rounded-full`}
          >
            {icon}
          </div>
        ))}
      ...
      <p className="w-[90%] md-[w-80%] xl:w-[70%] text-[18px] lg:text-[20px] customMargin text-center">
        ...
        wykładzie, omawiamy zasady ruchu drogowego, na podstawie filmów, plansz
        oraz czynnej dyskusji, uczymy również pierwszej pomocy. Spotkania
        odbywają się na ul.
        <span className="font-semibold"> Aleja Pokoju 5a </span> w piątki soboty
        i niedziele. Po zakończniu części teoretycznej organizujemy testy
        wewnętrzne.
      </p>
      <h2 className="section-title">
        Część
      ...
      <p className="w-[90%] md-[w-80%] xl:w-[70%] text-[18px] lg:text-[20px] customMargin text-center">
        ...
        <span className="font-semibold"> 30 godzin jazdy </span>30 godzin jazdy,
        zarówno na<span className="font-semibold"> placu manewrowym </span> jak
        i w<span className="font-semibold"> mieście </span>, w trakcie których
        nauczysz się swobodnie i bezpiecznie jezdzić samochodem. Dzięki naszemu
        szkoleniu bez problemu wykonasz wszystkie manwery, które musisz umieć
        aby zdać egzamin. Jazdy odbywają się w
